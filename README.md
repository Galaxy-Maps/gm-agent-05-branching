...
Generates optional side-quest branches off each curriculum Star.
...
```bash
git clone https://github.com/Galaxy-Maps/gm-agent-05-branching.git ~/.claude/skills/gm-agent-05-branching
```
